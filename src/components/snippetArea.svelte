...
<div class="flex flex-wrap">
	<div class="block w-full p-2.5 md:w-1/2">
		<label for="large-input" class="block text-sm font-medium ">Code</label>
		<div class="flex flex-row">
			...
			<textarea
				...
				rows={height}
				wrap="off"
				class="h-grow w-full resize-none bg-gray-50 py-1 px-2 text-sm leading-5  focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 "
	...
	<div class="block w-full p-2.5 md:w-1/2">
		<label for="large-input" class="block text-sm font-medium">Result</label>
		<div class="flex flex-row">
